...
function summaryToRow(
  ...
  return {
    ...
    active_promoters: summary.activePromoters || 0,
    video_creators: summary.videoCreators || 0,
    live_creators: summary.liveCreators || 0,
    both_video_and_live: summary.bothVideoAndLive || 0,
...
function rowToSummary(r: any): AffiliateMonthSummary {
  return {
    ...
    activePromoters: r.active_promoters || 0,
    videoCreators: r.video_creators || 0,
    liveCreators: r.live_creators || 0,
    bothVideoAndLive: r.both_video_and_live || 0,
